...
class Net(nn.Module):
    def __init__(self, num_channels, base_filter, feat, num_stages, scale_factor):
        ...
        # Reconstruction
        self.output_conv1 = ConvBlock(num_stages * base_filter, feat, 3, 1, 1, activation=None, norm=None)
        self.output_conv2 = ConvBlock(feat, num_channels, 3, 1, 1, activation=None, norm=None)
